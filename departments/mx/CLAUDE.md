# Merchants & Payments Department Context

This directory contains context documents for the Merchants & Payments department at Evermore.
...
│   └── assistant.md   # Merchants & Payments assistant prompt
└── CLAUDE.md          # This file
```
...
3. Use `prompts/assistant.md` as the session prompt for Merchants & Payments team members.
4. People profiles in `people/` contain individual role details.

## Data Classification

All content in this directory is classified as `internal` and scoped to the `mx` department via YAML frontmatter.
