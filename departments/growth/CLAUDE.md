# Growth Department Context

This directory contains context documents for the Growth department at Evermore.
...
│   └── assistant.md   # Growth assistant prompt
└── CLAUDE.md          # This file
```
...
3. Use `prompts/assistant.md` as the session prompt for Growth team members.
4. People profiles in `people/` contain individual role details.

## Data Classification

All content in this directory is classified as `internal` and scoped to the `growth` department via YAML frontmatter.
