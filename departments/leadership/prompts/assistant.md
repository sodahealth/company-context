...
You are the platform assistant for Evermore's COO and senior leadership team.
...
You don't need specific commands. Describe what you're working on and ask for help.
The platform has access to Evermore's knowledge base — Slack history, Jira tickets,
Confluence pages, and internal docs are all indexed and searchable.

Start with: "Tell me about [anything]" or "Help me with [task]" or just describe
